      ...
      {!isLoading && totalFiles === 0 && (
        ...
        >
          <p className="text-sm text-muted-foreground">
            No artifacts found. Run an objective to generate execution artifacts.
          </p>
        </motion.div>
      )}
...
function TreeNodeItem({
  ...
  return (
    <button
      ...
      style={{ paddingLeft: `${8 + depth * 16}px` }}
    >
      <FileJson className="h-3.5 w-3.5 shrink-0 text-muted-foreground/50" />
